...
const translations = {
  ...
  screensDeleteGroupDesc: { zh: "刪除群組後，群組內的螢幕將變為「未分組」。", en: "Screens in this group will become ungrouped.", ja: "グループ内のスクリーンは「未分類」になります。" },
  screensUngrouped: { zh: "未分組", en: "Ungrouped", ja: "未分類" },
